...
class Member extends Model {
  ...
  public classificationRuleId!: string;
  public financialSalary!: number;
  public financialEmploymentType!: string;
  public financialCurrency!: string;
  public financialAllowances!: number;
  public financialOccupationType!: string;
  public financialEstimatedIncome!: number;
  public financialBusinessType!: string;
  public financialBusinessName!: string;
  public financialEmployees!: number;
  public financialIncome!: number;
  public financialCapital!: number;
  public financialInvestmentType!: string;
  public financialCustomMonthlyFee!: number;
  public wingType!: string;
  public wingParentMemberId!: string;
  public registrationDate!: Date;
  public status!: string;
  public contributionMonthlyFee!: number;
  public contributionPercentage!: number;
  public contributionAnnualFee!: number;
  public contributionHqShare!: number;
  public contributionBranchShare!: number;
  public netSalaryGrossSalary!: number;
  public netSalaryPensionDeduction!: number;
  public netSalaryTaxDeduction!: number;
  public netSalaryTotalDeductions!: number;
  public netSalaryNetSalary!: number;
  public netSalaryContributionFee!: number;
  public netSalaryFinalNetSalary!: number;
