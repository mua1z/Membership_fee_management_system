...
export default function Security() {
  return (
    <div className="animate-in fade-in duration-1000 bg-white dark:bg-ebony pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-32">
           ...
           <div className="bg-slate-50 dark:bg-ebony-card border border-slate-100 dark:border-white/5 p-12 rounded-[3rem] shadow-xl hover:border-gold/30 transition-all duration-500">
              ...
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-lg font-medium">
                 Sessions are secured using JSON Web Tokens (JWT) with short-lived expiration. All API communications between the client and the backend require valid bearer tokens, preventing unauthorized access.
              </p>
           </div>
        </div>
           ...
           <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
              <div className="space-y-8">
                 ...
                 <p className="text-slate-400 leading-relaxed text-lg font-medium">
                    Every action, import, deletion, and payment modification is logged. The system maintains an immutable record of bulk changes, ensuring that administrative actions can be audited at any time.
                 </p>
              ...
              <div className="relative">
                 <div className="absolute inset-0 bg-primary/10 rounded-[3rem] blur-3xl"></div>
