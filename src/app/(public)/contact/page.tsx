    ...
    <div className="bg-white dark:bg-ebony pt-32 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-32">
          <h4 className="text-primary font-black uppercase tracking-[0.5em] text-[10px] mb-6">Get in Touch</h4>
          <h1 className="text-5xl lg:text-7xl font-black text-ebony dark:text-white mb-8 tracking-tighter">Contact Our Support</h1>
          <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-xl font-medium">Our technical and administrative teams are available 24/7 to assist you with the digital infrastructure.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
           ...
           <div className="bg-slate-50 dark:bg-ebony-card border border-slate-100 dark:border-white/10 rounded-[3rem] p-12 lg:p-16 shadow-2xl relative overflow-hidden group">
              <h3 className="text-3xl font-black text-ebony dark:text-white mb-10 tracking-tighter text-left">Send an Official Inquiry</h3>
              <form className="space-y-8 relative z-10">
                 ...
                 <button type="button" className="bg-primary text-white px-10 py-5 rounded-full text-xs font-black uppercase tracking-[0.3em] w-full flex justify-center items-center gap-4 hover:scale-[1.02] transition-all shadow-xl group">
