...
import { Download, Filter, Wallet, Banknote, Calculator, Building2, AlertTriangle, Users } from 'lucide-react'
      ...
      <div className="card">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <select
            ...
            className="input"
            style={{ display: (reportType === 'monthly' || reportType === 'defaulters') ? 'block' : 'none' }}
          >
              ...
              <div className="card">
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie
                      data={[
                        { name: `${t('common.hq_share')}`, value: hqBranch.hqShare.amount },
                        { name: `${t('common.branch_share')}`, value: hqBranch.branchShare.amount }
                      ]}
                      cx="50%"
                      cy="50%"
                      label
                    ...
                    {defaulters.defaulters?.length === 0 ? (
                      ...
                      defaulters.defaulters?.map((member: any) => (
                        <tr key={member._id}>
                          ...
                          <td><span className="badge badge-danger">{t('common.unpaid')}</span></td>
                        </tr>
                      ))
                    )}
                  </tbody>
